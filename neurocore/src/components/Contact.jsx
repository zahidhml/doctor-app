const locations = [
  {
    city: 'Peshawar',
    icon: '🏥',
    address: 'Phase 5, Hayatabad Medical Complex, Peshawar, KPK',
    phone: '+92-91-5701234',
    whatsapp: '923335701234',
    mapUrl: 'https://maps.google.com/?q=Hayatabad+Medical+Complex+Peshawar',
    hours: 'Mon–Wed: 9AM–2PM | Fri: 3PM–7PM | Sat: 9AM–12PM',
  },
  {
    city: 'Chitral',
    icon: '🏔️',
    address: 'Ataliq Bazaar, Near DHQ Hospital, Chitral, KPK',
    phone: '+92-943-412567',
    whatsapp: '923005412567',
    mapUrl: 'https://maps.google.com/?q=DHQ+Hospital+Chitral+KPK',
    hours: 'Thursday: 10AM–4PM (Visiting)',
  },
];
